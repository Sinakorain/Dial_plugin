...
- WASD moves the focused graph canvas viewport like a camera; typing in inline node fields does not move the canvas, and plain W/A/S/D are reserved instead of being valid palette shortcuts.
